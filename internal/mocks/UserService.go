...
func (_e *UserService_Expecter) GetAll() *UserService_GetAll_Call {
	return &UserService_GetAll_Call{Call: _e.mock.On("GetAll")}
}

func (_c *UserService_GetAll_Call) Run(run func()) *UserService_GetAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *UserService_GetAll_Call) RunAndReturn(run func() ([]domain.User, error)) *UserService_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
