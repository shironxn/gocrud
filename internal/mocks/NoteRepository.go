...
func (_m *NoteRepository) GetAll() ([]domain.Note, error) {
	ret := _m.Called()
...
func (_e *NoteRepository_Expecter) GetAll() *NoteRepository_GetAll_Call {
	return &NoteRepository_GetAll_Call{Call: _e.mock.On("GetAll")}
}

func (_c *NoteRepository_GetAll_Call) Run(run func()) *NoteRepository_GetAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *NoteRepository_GetAll_Call) RunAndReturn(run func() ([]domain.Note, error)) *NoteRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
