...
// GetByEmail provides a mock function with given fields: req
func (_m *UserRepository) GetByEmail(req domain.UserRequest) (*domain.User, error) {
	ret := _m.Called(req)
...
func (_e *UserRepository_Expecter) GetByEmail(req interface{}) *UserRepository_GetByEmail_Call {
	return &UserRepository_GetByEmail_Call{Call: _e.mock.On("GetByEmail", req)}
}

func (_c *UserRepository_GetByEmail_Call) Run(run func(req domain.UserRequest)) *UserRepository_GetByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserRepository_GetByEmail_Call) RunAndReturn(run func(domain.UserRequest) (*domain.User, error)) *UserRepository_GetByEmail_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function with given fields: req
func (_m *UserRepository) GetByID(req domain.UserRequest) (*domain.User, error) {
	ret := _m.Called(req)
...
//   - req domain.UserRequest
func (_e *UserRepository_Expecter) GetByID(req interface{}) *UserRepository_GetByID_Call {
	return &UserRepository_GetByID_Call{Call: _e.mock.On("GetByID", req)}
}

func (_c *UserRepository_GetByID_Call) Run(run func(req domain.UserRequest)) *UserRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(domain.UserRequest))
	})
	return _c
...
func (_c *UserRepository_GetByID_Call) RunAndReturn(run func(domain.UserRequest) (*domain.User, error)) *UserRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
